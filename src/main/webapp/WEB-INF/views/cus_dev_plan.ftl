...
<table id="dg"  class="easyui-datagrid"
    ...
    <tr>
        ...
        <th field="chanceSource" width="80" align="center" >机会来源</th>
        ...
        <th field="devResult" width="200" align="center" formatter="formatterDevResult"  styler="stylerDevResult">客户开发状态</th>
